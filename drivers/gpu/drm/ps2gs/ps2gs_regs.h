/*
 * ps2gs_regs.h  --  Playstation2 GS Registers Definitions
 *
 * Copyright (C) 2015, Rick Gaiser <rgaiser@gmail.com>
 *
 * Based on gs_privileged.h from ps2sdk
 *
...
#ifndef __PS2GS_REGS_H__
#define __PS2GS_REGS_H__
